...
namespace Pwe.Shared
{
    ...
    public static class GooglePolylineConverter
    {
        ...
        public static IEnumerable<GeoCoord> Decode(string polylineString)
        {
            ...
            while (index < polylineChars.Length)
            {
                ...
                yield return new GeoCoord(Convert.ToDouble(currentLng) / 1E5,Convert.ToDouble(currentLat) / 1E5);
            }
        }
        ...
        public static string Encode(IEnumerable<GeoCoord> locations)
        {
            ...
            foreach (var point in locations)
            {
                ...
                var lng = (int)Math.Round(point.Lon * 1E5);
